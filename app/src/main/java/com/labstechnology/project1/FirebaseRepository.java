...
import com.labstechnology.project1.CallBacks.FireBaseChildCallBack;
...
public abstract class FirebaseRepository {
     ...
     */
    protected final void fireBaseCreate(final DatabaseReference databaseReference, final Object model, final FireBaseCallBack callback) {
        databaseReference.keepSynced(true);
        databaseReference.setValue(model, new DatabaseReference.CompletionListener() {
            @Override
            public void onComplete(DatabaseError databaseError, @NonNull DatabaseReference databaseReference) {
                if (databaseError == null) {
                    callback.onSuccess(databaseReference.toString());
                } else {
     ...
     * @param callback          callback for event handling
     */
    protected final void fireBaseUpdateChildren(final DatabaseReference databaseReference, final Map map, final FireBaseCallBack callback) {
        databaseReference.keepSynced(true);
     ...
     * @param callback          callback for event handling
     */
    protected final void fireBaseDelete(final DatabaseReference databaseReference, final FireBaseCallBack callback) {
        databaseReference.keepSynced(true);
     ...
     * @param callback callback for event handling
     */
    protected final void fireBaseReadData(final Query query, final FireBaseCallBack callback) {
     ...
     */
    protected final ValueEventListener fireBaseDataChangeListener(final Query query, final FireBaseCallBack callback) {
        query.keepSynced(true);
